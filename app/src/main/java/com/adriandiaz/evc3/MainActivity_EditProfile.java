...
public class MainActivity_EditProfile extends AppCompatActivity {
    ImageView set;
    ProgressDialog pd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        set = findViewById(R.id.profile_img);
    ...
    protected  void onPause(){
        super.onPause();
        Glide.with(MainActivity_EditProfile.this).load(imageUri).into(set);
    ...
    private void uploadProfileCoverPhoto(final Uri uri) {
        ...
        pd.dismiss();
        Toast.makeText(MainActivity_EditProfile.this, "Updated Photo", Toast.LENGTH_LONG).show();
    }
