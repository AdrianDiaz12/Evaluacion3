...
public class EditFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.edit_perfil,container,false);
        editImage = view.findViewById(R.id.edit_image);
        set = view.findViewById(R.id.profile_img);
    ...
    public void onPause(){
        super.onPause();
        Glide.with(EditFragment.this).load(imageUri).into(set);
            ...
            case CAMERA_REQUEST: {
                if(grantResults.length > 0) {
                    ...
                    if(cameraAccepted && writeStorageAccepted){
                        ...
                        Toast.makeText(this.getContext(), "Please enable camera and storage permission", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(this.getContext(), "Something went wrong! try again...", Toast.LENGTH_LONG).show();
                }
            }
            break;
            case STORAGE_REQUEST: {
                if(grantResults.length > 0) {
                    ...
                    if(writeStorageAccepted){
                        ...
                        Toast.makeText(this.getContext(), "Please enable storage permission", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(this.getContext(), "Something went wrong! try again...", Toast.LENGTH_LONG).show();
                }
    ...
    private void uploadProfileCoverPhoto(final Uri uri) {
        ...
        pd.dismiss();
        Toast.makeText(EditFragment.this.getContext(), "Updated Photo", Toast.LENGTH_LONG).show();
    }
